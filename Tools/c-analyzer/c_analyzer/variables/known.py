...
def read_file(infile, *, _read_tsv=read_tsv):
...
def from_file(infile, *, handle_var=Variable.from_id, _read_file=read_file):
...
def look_up_variable(varid, knownvars, *, match_files=(lambda f1, f2: (f1 == f2))):
