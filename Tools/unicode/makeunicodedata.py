...
old_versions = ['3.2.0']
CATEGORY_NAMES = ['Cn', 'Lu', 'Ll', 'Lt', 'Mn', 'Mc', 'Me', 'Nd', 'Nl', 'No', 'Zs', 'Zl', 'Zp', 'Cc', 'Cf', 'Cs', 'Co', 'Cn', 'Lm', 'Lo', 'Pc', 'Pd', 'Ps', 'Pe', 'Pi', 'Pf', 'Po', 'Sm', 'Sc', 'Sk', 'So']
BIDIRECTIONAL_NAMES = ['', 'L', 'LRE', 'LRO', 'R', 'AL', 'RLE', 'RLO', 'PDF', 'EN', 'ES', 'ET', 'AN', 'CS', 'NSM', 'BN', 'B', 'S', 'WS', 'ON', 'LRI', 'RLI', 'FSI', 'PDI']
...
cjk_ranges = [('3400', '4DBF'), ('4E00', '9FFC'), ('20000', '2A6DD'), ('2A700', '2B734'), ('2B740', '2B81D'), ('2B820', '2CEA1'), ('2CEB0', '2EBE0'), ('30000', '3134A')]
...
def makeunicodedata(unicode, trace):
    ...
    for char in unicode.chars:
        ...
        if record:
            if record.decomposition_type:
                ...
                if ((not prefix) and (len(decomp) == 3) and (char not in unicode.exclusions) and (unicode.table[decomp[1]].canonical_combining_class == '0')):
                    (p, l, r) = decomp
                    comp_first[l] = 1
                    comp_last[r] = 1
    ...
    with open(FILE, 'w') as fp:
        ...
        for (version, table, normalization) in unicode.changed:
            ...
            fprint(('        index = changes_%s_data[(index<<%d)+(n & %d)];' % (cversion, shift, ((1 << shift) - 1))))
            fprint('    }')
...
def makeunicodename(unicode, trace):
    ...
    with open(FILE, 'w') as fp:
        ...
        fprint(('static const unsigned int named_sequences_end = %#x;' % (NAMED_SEQUENCES_START + len(unicode.named_sequences))))
...
def merge_old_version(version, new, old):
    ...
    new.changed.append((version, list(zip(bidir_changes, category_changes, decimal_changes, mirrored_changes, east_asian_width_changes, numeric_changes)), normalization_changes))
...
def myhash(s, magic):
    ...
    return h
SIZES = [(4, 3), (8, 3), (16, 3), (32, 5), (64, 3), (128, 3), (256, 29), (512, 17), (1024, 9), (2048, 5), (4096, 83), (8192, 27), (16384, 43), (32768, 3), (65536, 45), (131072, 9), (262144, 39), (524288, 39), (1048576, 9), (2097152, 5), (4194304, 3), (8388608, 33), (16777216, 27)]
