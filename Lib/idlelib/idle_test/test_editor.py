        ...
        for tabwidth in [1, 2, 4, 6, 8]:
            for line in ['', '\n']:
                with self.subTest(line=line, tabwidth=tabwidth):
                    self.assertEqual(editor.get_line_indent(line, tabwidth=tabwidth), (0, 0))

    def test_tabwidth_4(self):
        tests = (('no spaces', (0, 0)), ('    space test', (4, 4)), ('\ttab test', (1, 4)), ('\t\tdouble tabs test', (2, 8)), ('    \tmixed test', (5, 8)), ('  \t  mixed test', (5, 6)), ('\t    mixed test', (5, 8)), ('  \tmixed test', (3, 4)), (' \t mixed test', (3, 5)), ('\t  mixed test', (3, 6)), ('\nnewline test', (0, 0)))
        for (line, expected) in tests:
            with self.subTest(line=line):
                self.assertEqual(editor.get_line_indent(line, tabwidth=4), expected)

    def test_tabwidth_8(self):
        tests = (('no spaces', (0, 0)), ('        space test', (8, 8)), ('\ttab test', (1, 8)), ('\t\tdouble tabs test', (2, 16)), ('        \tmixed test', (9, 16)), ('      \t  mixed test', (9, 10)), ('\t        mixed test', (9, 16)), ('  \tmixed test', (3, 8)), (' \t mixed test', (3, 9)), ('\t  mixed test', (3, 10)), ('\nnewline test', (0, 0)))
        for (line, expected) in tests:
            with self.subTest(line=line):
