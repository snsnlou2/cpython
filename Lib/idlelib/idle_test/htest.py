...
tk.NoDefaultRoot()
AboutDialog_spec = {'file': 'help_about', 'kwds': {'title': 'help_about test', '_htest': True}, 'msg': 'Test every button. Ensure Python, TK and IDLE versions are correctly displayed.\n [Close] to exit.'}
