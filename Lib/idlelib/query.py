...
class Query(Toplevel):
    ...
    def __init__(self, parent, title, message, *, text0='', used_names={}, _htest=False, _utest=False):
...
class SectionName(Query):
    ...
    def __init__(self, parent, title, message, used_names, *, _htest=False, _utest=False):
        super().__init__(parent, title, message, used_names=used_names, _htest=_htest, _utest=_utest)
...
class HelpSource(Query):
    ...
    def browse_file(self):
        filetypes = [('HTML Files', '*.htm *.html', 'TEXT'), ('PDF Files', '*.pdf', 'TEXT'), ('Windows Help Files', '*.chm'), ('Text Files', '*.txt', 'TEXT'), ('All Files', '*')]
...
class CustomRun(Query):
    ...
    def create_extra(self):
        ...
        restart = Checkbutton(frame, variable=self.restartvar, onvalue=True, offvalue=False, text='Restart shell')
