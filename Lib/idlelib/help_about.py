...
class AboutDialog(Toplevel):
    ...
    def create_widgets(self):
        ...
        docs = Label(frame_background, text=(('https://docs.python.org/' + python_version()[:3]) + '/library/idle.html'), justify=LEFT, fg=self.fg, bg=self.bg)
        ...
        pyver = Label(frame_background, text=('Python version:  ' + python_version()), fg=self.fg, bg=self.bg)
        ...
        idlever = Label(frame_background, text=('IDLE version:   ' + python_version()), fg=self.fg, bg=self.bg)
