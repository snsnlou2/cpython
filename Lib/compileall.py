...
def main():
    ...
    parser.add_argument('-o', action='append', type=int, dest='opt_levels', help='Optimization levels to run compilation with.Default is -1 which uses optimization level ofPython interpreter itself (specified by -O).')
