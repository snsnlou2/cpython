...
def _as_int(n):
    ...
    import warnings
    warnings.warn(('Plural value must be an integer, got %s' % (n.__class__.__name__,)), DeprecationWarning, 4)
    return n
...
class NullTranslations():
    ...
    def install(self, names=None):
        ...
        if (names is not None):
            allowed = {'gettext', 'lgettext', 'lngettext', 'ngettext', 'npgettext', 'pgettext'}
