...
class uploadTestCase(BasePyPIRCCommandTestCase):
    ...
    def test_finalize_options(self):
        ...
        for (attr, waited) in (('username', 'me'), ('password', 'secret'), ('realm', 'pypi'), ('repository', 'https://upload.pypi.org/legacy/')):
    ...
    def test_upload(self):
        ...
        self.assertIn(b'cd2eb0837c9b4c962c22d2ff8b5441b7b45805887f051d39bf133b583baf6860', data)
        if (b'md5_digest' in data):
            self.assertIn(b'f561aaf6ef0bf14d4208bb46a4ccb3ad', data)
        if (b'blake2_256_digest' in data):
            self.assertIn(b'b6f289a27d4fe90da63c503bfe0a9b761a8f76bb86148565065f040be6d1c3044cf7ded78ef800509bccb4b648e507d88dc6383d67642aadccce443f1534330a', data)
