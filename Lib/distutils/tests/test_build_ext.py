...
from distutils.tests.support import TempdirManager, LoggingSilencer, copy_xxmodule_c, fixup_build_ext
...
class BuildExtTestCase(TempdirManager, LoggingSilencer, unittest.TestCase):
    ...
    def test_unicode_module_names(self):
        modules = [Extension('foo', ['aaa'], optional=False), Extension('föö', ['uuu'], optional=False)]
        dist = Distribution({'name': 'xx', 'ext_modules': modules})
        cmd = self.build_ext(dist)
        cmd.ensure_finalized()
