...
def coroutine(func):
    ...
    warnings.warn('"@coroutine" decorator is deprecated since Python 3.8, use "async def" instead', DeprecationWarning, stacklevel=2)
...
def _format_coroutine(coro):
    ...
    lineno = 0
    if (is_corowrapper and (coro.func is not None) and (not inspect.isgeneratorfunction(coro.func))):
