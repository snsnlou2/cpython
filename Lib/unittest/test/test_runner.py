...
class TestClassCleanup(unittest.TestCase):
    ...
    def test_with_errors_addCleanUp(self):
        ...
        self.assertEqual(result.errors[0][1].splitlines()[(- 1)], 'Exception: CleanUpExc')
    ...
    def test_with_errors_in_addClassCleanup_and_setUps(self):
        ...
        self.assertEqual(result.errors[1][1].splitlines()[(- 1)], 'Exception: CleanUpExc')
...
class TestModuleCleanUp(unittest.TestCase):
    ...
    def test_run_module_cleanUp(self):
        ...
        self.assertEqual(result.errors[0][1].splitlines()[(- 1)], 'Exception: setUpModule Exc')
        ordering = []
        blowUp = False
        runTests(TestableTest)
