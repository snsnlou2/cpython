...
class TestSpecifics(unittest.TestCase):
    ...
    def test_compiler_recursion_limit(self):
        ...
        def check_limit(prefix, repeated):
            ...
            details = 'Compiling ({!r} + {!r} * {})'.format(prefix, repeated, fail_depth)
    ...
    def check_constant(self, func, expected):
        for const in func.__code__.co_consts:
            ...
            self.fail(('unable to find constant %r in %r' % (expected, func.__code__.co_consts)))
...
class TestStackSizeStability(unittest.TestCase):
    ...
    def check_stack_size(self, snippet, async_=False):
        ...
        if (len(set(sizes)) != 1):
            ...
            self.fail(('stack sizes diverge with # of consecutive snippets: %s\n%s\n%s' % (sizes, snippet, out.getvalue())))
