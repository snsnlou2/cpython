...
(TestLegacyAPI_Py, TestABC_Py, TestABCWithInitSubclass_Py) = test_factory(abc.ABCMeta, abc.get_cache_token)
(TestLegacyAPI_C, TestABC_C, TestABCWithInitSubclass_C) = test_factory(_py_abc.ABCMeta, _py_abc.get_cache_token)
