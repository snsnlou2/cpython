...
@unittest.skipUnless(hasattr(selectors, 'EpollSelector'), 'Test needs selectors.EpollSelector')
...
@unittest.skipUnless(hasattr(selectors, 'KqueueSelector'), 'Test needs selectors.KqueueSelector)')
...
@unittest.skipUnless(hasattr(selectors, 'DevpollSelector'), 'Test needs selectors.DevpollSelector')
class DevpollSelectorTestCase(BaseSelectorTestCase, ScalableSelectorMixIn):
    SELECTOR = getattr(selectors, 'DevpollSelector', None)

def test_main():
    tests = [DefaultSelectorTestCase, SelectSelectorTestCase, PollSelectorTestCase, EpollSelectorTestCase, KqueueSelectorTestCase, DevpollSelectorTestCase]
