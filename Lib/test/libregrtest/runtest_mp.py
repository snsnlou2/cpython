...
from test.libregrtest.runtest import runtest, INTERRUPTED, CHILD_ERROR, PROGRESS_MIN_TIME, format_test_result, TestResult, is_failed, TIMEOUT
...
def run_test_in_subprocess(testname, ns):
    ...
    cmd = [sys.executable, *support.args_from_interpreter_flags(), '-u', '-m', 'test.regrtest', '--worker-args', worker_args]
    kw = {}
...
MultiprocessResult = collections.namedtuple('MultiprocessResult', 'result stdout stderr error_msg')
...
class TestWorkerProcess(threading.Thread):
    ...
    def mp_result_error(self, test_name, error_type, stdout='', stderr='', err_msg=None):
