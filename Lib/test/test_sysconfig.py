...
class TestSysConfig(unittest.TestCase):
    ...
    def test_get_scheme_names(self):
        wanted = ('nt', 'nt_user', 'osx_framework_user', 'posix_home', 'posix_prefix', 'posix_user')
    ...
    @unittest.skipUnless(((sys.platform == 'linux') and hasattr(sys.implementation, '_multiarch')), 'multiarch-specific test')
