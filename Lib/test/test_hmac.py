...
class TestVectorsTestCase(unittest.TestCase):
    ...
    def asssert_hmac(self, key, data, digest, hashfunc, hashname, digest_size, block_size):
    ...
    def test_md5_vectors(self):
        ...
        def md5test(key, data, digest):
            self.asssert_hmac(key, data, digest, hashfunc=hashlib.md5, hashname='md5', digest_size=16, block_size=64)
    ...
    def test_sha_vectors(self):
        ...
        def shatest(key, data, digest):
            self.asssert_hmac(key, data, digest, hashfunc=hashlib.sha1, hashname='sha1', digest_size=20, block_size=64)
    ...
    def _rfc4231_test_cases(self, hashfunc, hash_name, digest_size, block_size):
        ...
        def hmactest(key, data, hexdigests):
            ...
            self.asssert_hmac(key, data, digest, hashfunc=hashfunc, hashname=hash_name, digest_size=digest_size, block_size=block_size)
...
class CopyTestCase(unittest.TestCase):
    ...
    def test_attributes(self):
        ...
        h2 = h1.copy()
        self.assertTrue((h1._digest_cons == h2._digest_cons), "digest constructors don't match.")
