...
class PkgutilPEP302Tests(unittest.TestCase):
    ...
    class MyTestImporter(object):
        ...
        def find_spec(self, fullname, path=None, target=None):
            ...
            return spec_from_file_location(fullname, ('<%s>' % loader.__class__.__name__), loader=loader, submodule_search_locations=[])
...
class ImportlibMigrationTests(unittest.TestCase):
    ...
    def check_deprecated(self):
        return check_warnings(("This emulation is deprecated, use 'importlib' instead", DeprecationWarning))
...
def test_main():
    run_unittest(PkgutilTests, PkgutilPEP302Tests, ExtendPathTests, NestedNamespacePackageTest, ImportlibMigrationTests)
    import zipimport
    import importlib
