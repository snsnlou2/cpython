...
class DirCompareTestCase(unittest.TestCase):
    ...
    def test_dircmp(self):
        ...
        expected_report = ['diff {} {}'.format(self.dir, self.dir_same), "Identical files : ['file']"]
        ...
        self.assertEqual(d.same_files, ['file'])
        self.assertEqual(d.diff_files, [])
        expected_report = ['diff {} {}'.format(self.dir, self.dir_diff), "Only in {} : ['file2']".format(self.dir_diff), "Identical files : ['file']"]
        self._assert_report(d.report, expected_report)
        (left_dir, right_dir) = (self.dir, self.dir_diff)
        ...
        self.assertEqual(d.same_files, ['file'])
        self.assertEqual(d.diff_files, [])
        expected_report = ['diff {} {}'.format(self.dir, self.dir_diff), "Only in {} : ['file2']".format(self.dir), "Identical files : ['file']"]
        self._assert_report(d.report, expected_report)
        with open(os.path.join(self.dir_diff, 'file2'), 'w') as output:
            output.write('Different contents.\n')
        ...
        expected_report = ['diff {} {}'.format(self.dir, self.dir_diff), "Identical files : ['file']", "Differing files : ['file2']"]
        self._assert_report(d.report, expected_report)
