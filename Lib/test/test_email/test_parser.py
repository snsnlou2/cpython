    ...
    def test_only_split_on_cr_lf(self):
        for parser in self.parsers:
            with self.subTest(parser=parser.__name__):
                msg = parser('Next-Line: not\x85broken\r\nNull: not\x00broken\r\nVertical-Tab: not\x0bbroken\r\nForm-Feed: not\x0cbroken\r\nFile-Separator: not\x1cbroken\r\nGroup-Separator: not\x1dbroken\r\nRecord-Separator: not\x1ebroken\r\nLine-Separator: not\u2028broken\r\nParagraph-Separator: not\u2029broken\r\n\r\n', policy=default)
                self.assertEqual(msg.items(), [('Next-Line', 'not\x85broken'), ('Null', 'not\x00broken'), ('Vertical-Tab', 'not\x0bbroken'), ('Form-Feed', 'not\x0cbroken'), ('File-Separator', 'not\x1cbroken'), ('Group-Separator', 'not\x1dbroken'), ('Record-Separator', 'not\x1ebroken'), ('Line-Separator', 'not\u2028broken'), ('Paragraph-Separator', 'not\u2029broken')])
