...
class CgiTests(unittest.TestCase):
    ...
    def test_fieldstorage_as_context_manager(self):
        ...
        with self.assertRaisesRegex(ValueError, 'I/O operation on closed file'):
            fs.file.read()
    _qs_result = {'key1': 'value1', 'key2': ['value2x', 'value2y'], 'key3': 'value3', 'key4': 'value4'}

    def testQSAndUrlEncode(self):
        data = 'key2=value2x&key3=value3&key4=value4'
        environ = {'CONTENT_LENGTH': str(len(data)), 'CONTENT_TYPE': 'application/x-www-form-urlencoded', 'QUERY_STRING': 'key1=value1&key2=value2y', 'REQUEST_METHOD': 'POST'}
    ...
    def testQSAndFormData(self):
        ...
        environ = {'CONTENT_LENGTH': str(len(data)), 'CONTENT_TYPE': 'multipart/form-data; boundary=-123', 'QUERY_STRING': 'key1=value1&key2=value2x', 'REQUEST_METHOD': 'POST'}
        v = gen_result(data, environ)
        self.assertEqual(self._qs_result, v)
