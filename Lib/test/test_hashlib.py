...
class HashLibTestCase(unittest.TestCase):
    ...
    def check(self, name, data, hexdigest, shake=False, **kwargs):
        ...
        for hash_object_constructor in constructors:
            ...
            self.assertEqual(computed, hexdigest, ('Hash algorithm %s constructed using %s returned hexdigest %r for %d byte input data that should have hashed to %r.' % (name, hash_object_constructor, computed, len(data), hexdigest)))
    ...
    def check_blocksize_name(self, name, block_size=0, digest_size=0, digest_length=None):
        constructors = self.constructors_to_test[name]
        for hash_object_constructor in constructors:
    ...
    def test_case_sha1_2(self):
        self.check('sha1', b'abcdbcdecdefdefgefghfghighijhijkijkljklmklmnlmnomnopnopq', '84983e441c3bd26ebaae4aa1f95129e5e54670f1')

    def test_case_sha1_3(self):
        self.check('sha1', (b'a' * 1000000), '34aa973cd4c4daa4f61eeb2bdbad27316534016f')

    def test_case_sha224_0(self):
        self.check('sha224', b'', 'd14a028c2a3a2bc9476102bb288234c415a2b01f828ea62ac5b3e42f')

    def test_case_sha224_1(self):
        self.check('sha224', b'abc', '23097d223405d8228642a477bda255b32aadbce4bda0b3f7e36c9da7')

    def test_case_sha224_2(self):
        self.check('sha224', b'abcdbcdecdefdefgefghfghighijhijkijkljklmklmnlmnomnopnopq', '75388b16512776cc5dba5da1fd890150b0c6455cb4f58b1952522525')

    def test_case_sha224_3(self):
        self.check('sha224', (b'a' * 1000000), '20794655980c91d8bbb4c1ea97618a4bf03f42581948b2ee4ee7ad67')

    def test_case_sha256_0(self):
        self.check('sha256', b'', 'e3b0c44298fc1c149afbf4c8996fb92427ae41e4649b934ca495991b7852b855')

    def test_case_sha256_1(self):
        self.check('sha256', b'abc', 'ba7816bf8f01cfea414140de5dae2223b00361a396177a9cb410ff61f20015ad')

    def test_case_sha256_2(self):
        self.check('sha256', b'abcdbcdecdefdefgefghfghighijhijkijkljklmklmnlmnomnopnopq', '248d6a61d20638b8e5c026930c3e6039a33ce45964ff2167f6ecedd419db06c1')

    def test_case_sha256_3(self):
        self.check('sha256', (b'a' * 1000000), 'cdc76e5c9914fb9281a1c7e284d73e67f1809a48a497200e046d39ccc7112cd0')

    def test_case_sha384_0(self):
        self.check('sha384', b'', ('38b060a751ac96384cd9327eb1b1e36a21fdb71114be07434c0cc7bf63f6e1da' + '274edebfe76f65fbd51ad2f14898b95b'))
    ...
    def test_case_sha384_2(self):
        self.check('sha384', (b'abcdefghbcdefghicdefghijdefghijkefghijklfghijklmghijklmn' + b'hijklmnoijklmnopjklmnopqklmnopqrlmnopqrsmnopqrstnopqrstu'), ('09330c33f71147e83d192fc782cd1b4753111b173b3b05d22fa08086e3b0f712' + 'fcc7c71a557e2db966c3e9fa91746039'))
    ...
    def test_case_sha512_0(self):
        self.check('sha512', b'', ('cf83e1357eefb8bdf1542850d66d8007d620e4050b5715dc83f4a921d36ce9ce' + '47d0d13c5d85f2b0ff8318d2877eec2f63b931bd47417a81a538327af927da3e'))

    def test_case_sha512_1(self):
        self.check('sha512', b'abc', ('ddaf35a193617abacc417349ae20413112e6fa4e89a97ea20a9eeee64b55d39a' + '2192992a274fc1a836ba3c23a3feebbd454d4423643ce80e2a9ac94fa54ca49f'))

    def test_case_sha512_2(self):
        self.check('sha512', (b'abcdefghbcdefghicdefghijdefghijkefghijklfghijklmghijklmn' + b'hijklmnoijklmnopjklmnopqklmnopqrlmnopqrsmnopqrstnopqrstu'), ('8e959b75dae313da8cf4f72814fc143f8f7779c6eb9f7fa17299aeadb6889018' + '501d289e4900f7e4331b99dec4b5433ac7d329eeb6dd26545e96e55b874be909'))
    ...
    def check_blake2(self, constructor, salt_size, person_size, key_size, digest_size, max_offset):
    ...
    def test_case_blake2b_0(self):
        self.check('blake2b', b'', ('786a02f742015903c6c6fd852552d272912f4740e15847618a86e217f71f5419' + 'd25e1031afee585313896444934eb04b903a685b1448b755d56f701afe9be2ce'))

    @requires_blake2
    def test_case_blake2b_1(self):
        self.check('blake2b', b'abc', ('ba80a53f981c4d0d6a2797b69f12f6e94c212f14685ac4b74b12bb6fdbffa2d1' + '7d87c5392aab792dc252d5de4533cc9518d38aa8dbf1925ab92386edd4009923'))
    ...
    def test_case_blake2s_0(self):
        self.check('blake2s', b'', '69217a3079908094e11121d042354a7c1f55b6482ca1a51e1b250dfd1ed0eef9')

    @requires_blake2
    def test_case_blake2s_1(self):
        self.check('blake2s', b'abc', '508c5e8c327c14e2e1a72ba34eeb452f37458b209ed63a294d999b4c86675982')
    ...
    def test_case_sha3_224_0(self):
        self.check('sha3_224', b'', '6b4e03423667dbb73b6e15454f0eb1abd4597f9a1b078e3f5b5a6bc7')
    ...
    def test_case_sha3_256_0(self):
        self.check('sha3_256', b'', 'a7ffc6f8bf1ed76651c14756a061d662f580ff4de43b49fa82d80a4b80f8434a')
    ...
    def test_case_sha3_384_0(self):
        self.check('sha3_384', b'', ('0c63a75b845e4f7d01107d852e4c2485c51a50aaaa94fc61995e71bbee983a2a' + 'c3713831264adb47fb6bd1e058d5f004'))
    ...
    def test_case_sha3_512_0(self):
        self.check('sha3_512', b'', ('a69f73cca23a9ac5c8b567dc185a756e97c982164fe25859e0d1dcc1475c80a6' + '15b2123af1f5f94c11e3e9402c3ac558f500199d95b6d3e301758586281dcd26'))
...
class KDFTests(unittest.TestCase):
    ...
    def _test_pbkdf2_hmac(self, pbkdf2, supported):
        for (digest_name, results) in self.pbkdf2_results.items():
            ...
            for (i, vector) in enumerate(self.pbkdf2_test_vectors):
                ...
                self.assertEqual(out, expected, (digest_name, password, salt, rounds, dklen))
                ...
                if (dklen is None):
                    ...
                    self.assertEqual(out, expected, (digest_name, password, salt, rounds))
    ...
    @unittest.skipUnless(hasattr(c_hashlib, 'pbkdf2_hmac'), '   test requires OpenSSL > 1.0')
    def test_pbkdf2_hmac_c(self):
        self._test_pbkdf2_hmac(c_hashlib.pbkdf2_hmac, openssl_md_meth_names)

    @unittest.skipUnless(hasattr(c_hashlib, 'scrypt'), '   test requires OpenSSL > 1.1')
