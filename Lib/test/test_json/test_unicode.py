...
class TestUnicode():
    ...
    def test_bytes_decode(self):
        for (encoding, bom) in [('utf-8', codecs.BOM_UTF8), ('utf-16be', codecs.BOM_UTF16_BE), ('utf-16le', codecs.BOM_UTF16_LE), ('utf-32be', codecs.BOM_UTF32_BE), ('utf-32le', codecs.BOM_UTF32_LE)]:
            data = ['aµ€𝄠']
