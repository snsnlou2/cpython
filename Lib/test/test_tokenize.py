...
class TokenizeTest(TestCase):
    ...
    def check_tokenize(self, s, expected):
        ...
        self.assertEqual(result, (["    ENCODING   'utf-8'       (0, 0) (0, 0)"] + expected.rstrip().splitlines()))
    ...
    def test_string(self):
        self.check_tokenize('x = \'\'; y = ""', '    NAME       \'x\'           (1, 0) (1, 1)\n    OP         \'=\'           (1, 2) (1, 3)\n    STRING     "\'\'"          (1, 4) (1, 6)\n    OP         \';\'           (1, 6) (1, 7)\n    NAME       \'y\'           (1, 8) (1, 9)\n    OP         \'=\'           (1, 10) (1, 11)\n    STRING     \'""\'          (1, 12) (1, 14)\n    ')
        self.check_tokenize('x = \'"\'; y = "\'"', '    NAME       \'x\'           (1, 0) (1, 1)\n    OP         \'=\'           (1, 2) (1, 3)\n    STRING     \'\\\'"\\\'\'       (1, 4) (1, 7)\n    OP         \';\'           (1, 7) (1, 8)\n    NAME       \'y\'           (1, 9) (1, 10)\n    OP         \'=\'           (1, 11) (1, 12)\n    STRING     \'"\\\'"\'        (1, 13) (1, 16)\n    ')
        self.check_tokenize('x = "doesn\'t "shrink", does it"', '    NAME       \'x\'           (1, 0) (1, 1)\n    OP         \'=\'           (1, 2) (1, 3)\n    STRING     \'"doesn\\\'t "\' (1, 4) (1, 14)\n    NAME       \'shrink\'      (1, 14) (1, 20)\n    STRING     \'", does it"\' (1, 20) (1, 31)\n    ')
        self.check_tokenize("x = 'abc' + 'ABC'", '    NAME       \'x\'           (1, 0) (1, 1)\n    OP         \'=\'           (1, 2) (1, 3)\n    STRING     "\'abc\'"       (1, 4) (1, 9)\n    OP         \'+\'           (1, 10) (1, 11)\n    STRING     "\'ABC\'"       (1, 12) (1, 17)\n    ')
        self.check_tokenize('y = "ABC" + "ABC"', '    NAME       \'y\'           (1, 0) (1, 1)\n    OP         \'=\'           (1, 2) (1, 3)\n    STRING     \'"ABC"\'       (1, 4) (1, 9)\n    OP         \'+\'           (1, 10) (1, 11)\n    STRING     \'"ABC"\'       (1, 12) (1, 17)\n    ')
        self.check_tokenize("x = r'abc' + r'ABC' + R'ABC' + R'ABC'", '    NAME       \'x\'           (1, 0) (1, 1)\n    OP         \'=\'           (1, 2) (1, 3)\n    STRING     "r\'abc\'"      (1, 4) (1, 10)\n    OP         \'+\'           (1, 11) (1, 12)\n    STRING     "r\'ABC\'"      (1, 13) (1, 19)\n    OP         \'+\'           (1, 20) (1, 21)\n    STRING     "R\'ABC\'"      (1, 22) (1, 28)\n    OP         \'+\'           (1, 29) (1, 30)\n    STRING     "R\'ABC\'"      (1, 31) (1, 37)\n    ')
        self.check_tokenize('y = r"abc" + r"ABC" + R"ABC" + R"ABC"', '    NAME       \'y\'           (1, 0) (1, 1)\n    OP         \'=\'           (1, 2) (1, 3)\n    STRING     \'r"abc"\'      (1, 4) (1, 10)\n    OP         \'+\'           (1, 11) (1, 12)\n    STRING     \'r"ABC"\'      (1, 13) (1, 19)\n    OP         \'+\'           (1, 20) (1, 21)\n    STRING     \'R"ABC"\'      (1, 22) (1, 28)\n    OP         \'+\'           (1, 29) (1, 30)\n    STRING     \'R"ABC"\'      (1, 31) (1, 37)\n    ')
        self.check_tokenize("u'abc' + U'abc'", '    STRING     "u\'abc\'"      (1, 0) (1, 6)\n    OP         \'+\'           (1, 7) (1, 8)\n    STRING     "U\'abc\'"      (1, 9) (1, 15)\n    ')
        self.check_tokenize('u"abc" + U"abc"', '    STRING     \'u"abc"\'      (1, 0) (1, 6)\n    OP         \'+\'           (1, 7) (1, 8)\n    STRING     \'U"abc"\'      (1, 9) (1, 15)\n    ')
        self.check_tokenize("b'abc' + B'abc'", '    STRING     "b\'abc\'"      (1, 0) (1, 6)\n    OP         \'+\'           (1, 7) (1, 8)\n    STRING     "B\'abc\'"      (1, 9) (1, 15)\n    ')
        self.check_tokenize('b"abc" + B"abc"', '    STRING     \'b"abc"\'      (1, 0) (1, 6)\n    OP         \'+\'           (1, 7) (1, 8)\n    STRING     \'B"abc"\'      (1, 9) (1, 15)\n    ')
        self.check_tokenize("br'abc' + bR'abc' + Br'abc' + BR'abc'", '    STRING     "br\'abc\'"     (1, 0) (1, 7)\n    OP         \'+\'           (1, 8) (1, 9)\n    STRING     "bR\'abc\'"     (1, 10) (1, 17)\n    OP         \'+\'           (1, 18) (1, 19)\n    STRING     "Br\'abc\'"     (1, 20) (1, 27)\n    OP         \'+\'           (1, 28) (1, 29)\n    STRING     "BR\'abc\'"     (1, 30) (1, 37)\n    ')
        self.check_tokenize('br"abc" + bR"abc" + Br"abc" + BR"abc"', '    STRING     \'br"abc"\'     (1, 0) (1, 7)\n    OP         \'+\'           (1, 8) (1, 9)\n    STRING     \'bR"abc"\'     (1, 10) (1, 17)\n    OP         \'+\'           (1, 18) (1, 19)\n    STRING     \'Br"abc"\'     (1, 20) (1, 27)\n    OP         \'+\'           (1, 28) (1, 29)\n    STRING     \'BR"abc"\'     (1, 30) (1, 37)\n    ')
        self.check_tokenize("rb'abc' + rB'abc' + Rb'abc' + RB'abc'", '    STRING     "rb\'abc\'"     (1, 0) (1, 7)\n    OP         \'+\'           (1, 8) (1, 9)\n    STRING     "rB\'abc\'"     (1, 10) (1, 17)\n    OP         \'+\'           (1, 18) (1, 19)\n    STRING     "Rb\'abc\'"     (1, 20) (1, 27)\n    OP         \'+\'           (1, 28) (1, 29)\n    STRING     "RB\'abc\'"     (1, 30) (1, 37)\n    ')
        self.check_tokenize('rb"abc" + rB"abc" + Rb"abc" + RB"abc"', '    STRING     \'rb"abc"\'     (1, 0) (1, 7)\n    OP         \'+\'           (1, 8) (1, 9)\n    STRING     \'rB"abc"\'     (1, 10) (1, 17)\n    OP         \'+\'           (1, 18) (1, 19)\n    STRING     \'Rb"abc"\'     (1, 20) (1, 27)\n    OP         \'+\'           (1, 28) (1, 29)\n    STRING     \'RB"abc"\'     (1, 30) (1, 37)\n    ')
        ...
        self.check_tokenize('u"""a\\\nb"""', '    STRING     \'u"""a\\\\\\nb"""\' (1, 0) (2, 4)\n    ')
        self.check_tokenize('rb"""a\\\nb\\\nc"""', '    STRING     \'rb"""a\\\\\\nb\\\\\\nc"""\' (1, 0) (3, 4)\n    ')
        self.check_tokenize('f"abc"', '    STRING     \'f"abc"\'      (1, 0) (1, 6)\n    ')
        self.check_tokenize('fR"a{b}c"', '    STRING     \'fR"a{b}c"\'   (1, 0) (1, 9)\n    ')
        self.check_tokenize('f"""abc"""', '    STRING     \'f"""abc"""\'  (1, 0) (1, 10)\n    ')
        self.check_tokenize('f"abc\\\ndef"', '    STRING     \'f"abc\\\\\\ndef"\' (1, 0) (2, 4)\n    ')
        self.check_tokenize('Rf"abc\\\ndef"', '    STRING     \'Rf"abc\\\\\\ndef"\' (1, 0) (2, 4)\n    ')

    def test_function(self):
        self.check_tokenize('def d22(a, b, c=2, d=2, *k): pass', "    NAME       'def'         (1, 0) (1, 3)\n    NAME       'd22'         (1, 4) (1, 7)\n    OP         '('           (1, 7) (1, 8)\n    NAME       'a'           (1, 8) (1, 9)\n    OP         ','           (1, 9) (1, 10)\n    NAME       'b'           (1, 11) (1, 12)\n    OP         ','           (1, 12) (1, 13)\n    NAME       'c'           (1, 14) (1, 15)\n    OP         '='           (1, 15) (1, 16)\n    NUMBER     '2'           (1, 16) (1, 17)\n    OP         ','           (1, 17) (1, 18)\n    NAME       'd'           (1, 19) (1, 20)\n    OP         '='           (1, 20) (1, 21)\n    NUMBER     '2'           (1, 21) (1, 22)\n    OP         ','           (1, 22) (1, 23)\n    OP         '*'           (1, 24) (1, 25)\n    NAME       'k'           (1, 25) (1, 26)\n    OP         ')'           (1, 26) (1, 27)\n    OP         ':'           (1, 27) (1, 28)\n    NAME       'pass'        (1, 29) (1, 33)\n    ")
        self.check_tokenize('def d01v_(a=1, *k, **w): pass', "    NAME       'def'         (1, 0) (1, 3)\n    NAME       'd01v_'       (1, 4) (1, 9)\n    OP         '('           (1, 9) (1, 10)\n    NAME       'a'           (1, 10) (1, 11)\n    OP         '='           (1, 11) (1, 12)\n    NUMBER     '1'           (1, 12) (1, 13)\n    OP         ','           (1, 13) (1, 14)\n    OP         '*'           (1, 15) (1, 16)\n    NAME       'k'           (1, 16) (1, 17)\n    OP         ','           (1, 17) (1, 18)\n    OP         '**'          (1, 19) (1, 21)\n    NAME       'w'           (1, 21) (1, 22)\n    OP         ')'           (1, 22) (1, 23)\n    OP         ':'           (1, 23) (1, 24)\n    NAME       'pass'        (1, 25) (1, 29)\n    ")
        self.check_tokenize('def d23(a: str, b: int=3) -> int: pass', "    NAME       'def'         (1, 0) (1, 3)\n    NAME       'd23'         (1, 4) (1, 7)\n    OP         '('           (1, 7) (1, 8)\n    NAME       'a'           (1, 8) (1, 9)\n    OP         ':'           (1, 9) (1, 10)\n    NAME       'str'         (1, 11) (1, 14)\n    OP         ','           (1, 14) (1, 15)\n    NAME       'b'           (1, 16) (1, 17)\n    OP         ':'           (1, 17) (1, 18)\n    NAME       'int'         (1, 19) (1, 22)\n    OP         '='           (1, 22) (1, 23)\n    NUMBER     '3'           (1, 23) (1, 24)\n    OP         ')'           (1, 24) (1, 25)\n    OP         '->'          (1, 26) (1, 28)\n    NAME       'int'         (1, 29) (1, 32)\n    OP         ':'           (1, 32) (1, 33)\n    NAME       'pass'        (1, 34) (1, 38)\n    ")

    def test_comparison(self):
        self.check_tokenize('if 1 < 1 > 1 == 1 >= 5 <= 0x15 <= 0x12 != 1 and 5 in 1 not in 1 is 1 or 5 is not 1: pass', "    NAME       'if'          (1, 0) (1, 2)\n    NUMBER     '1'           (1, 3) (1, 4)\n    OP         '<'           (1, 5) (1, 6)\n    NUMBER     '1'           (1, 7) (1, 8)\n    OP         '>'           (1, 9) (1, 10)\n    NUMBER     '1'           (1, 11) (1, 12)\n    OP         '=='          (1, 13) (1, 15)\n    NUMBER     '1'           (1, 16) (1, 17)\n    OP         '>='          (1, 18) (1, 20)\n    NUMBER     '5'           (1, 21) (1, 22)\n    OP         '<='          (1, 23) (1, 25)\n    NUMBER     '0x15'        (1, 26) (1, 30)\n    OP         '<='          (1, 31) (1, 33)\n    NUMBER     '0x12'        (1, 34) (1, 38)\n    OP         '!='          (1, 39) (1, 41)\n    NUMBER     '1'           (1, 42) (1, 43)\n    NAME       'and'         (1, 44) (1, 47)\n    NUMBER     '5'           (1, 48) (1, 49)\n    NAME       'in'          (1, 50) (1, 52)\n    NUMBER     '1'           (1, 53) (1, 54)\n    NAME       'not'         (1, 55) (1, 58)\n    NAME       'in'          (1, 59) (1, 61)\n    NUMBER     '1'           (1, 62) (1, 63)\n    NAME       'is'          (1, 64) (1, 66)\n    NUMBER     '1'           (1, 67) (1, 68)\n    NAME       'or'          (1, 69) (1, 71)\n    NUMBER     '5'           (1, 72) (1, 73)\n    NAME       'is'          (1, 74) (1, 76)\n    NAME       'not'         (1, 77) (1, 80)\n    NUMBER     '1'           (1, 81) (1, 82)\n    OP         ':'           (1, 82) (1, 83)\n    NAME       'pass'        (1, 84) (1, 88)\n    ")
    ...
    def test_async(self):
        self.check_tokenize('async = 1', "    NAME       'async'       (1, 0) (1, 5)\n    OP         '='           (1, 6) (1, 7)\n    NUMBER     '1'           (1, 8) (1, 9)\n    ")
        self.check_tokenize('a = (async = 1)', "    NAME       'a'           (1, 0) (1, 1)\n    OP         '='           (1, 2) (1, 3)\n    OP         '('           (1, 4) (1, 5)\n    NAME       'async'       (1, 5) (1, 10)\n    OP         '='           (1, 11) (1, 12)\n    NUMBER     '1'           (1, 13) (1, 14)\n    OP         ')'           (1, 14) (1, 15)\n    ")
        self.check_tokenize('async()', "    NAME       'async'       (1, 0) (1, 5)\n    OP         '('           (1, 5) (1, 6)\n    OP         ')'           (1, 6) (1, 7)\n    ")
        self.check_tokenize('class async(Bar):pass', "    NAME       'class'       (1, 0) (1, 5)\n    NAME       'async'       (1, 6) (1, 11)\n    OP         '('           (1, 11) (1, 12)\n    NAME       'Bar'         (1, 12) (1, 15)\n    OP         ')'           (1, 15) (1, 16)\n    OP         ':'           (1, 16) (1, 17)\n    NAME       'pass'        (1, 17) (1, 21)\n    ")
        self.check_tokenize('class async:pass', "    NAME       'class'       (1, 0) (1, 5)\n    NAME       'async'       (1, 6) (1, 11)\n    OP         ':'           (1, 11) (1, 12)\n    NAME       'pass'        (1, 12) (1, 16)\n    ")
        self.check_tokenize('await = 1', "    NAME       'await'       (1, 0) (1, 5)\n    OP         '='           (1, 6) (1, 7)\n    NUMBER     '1'           (1, 8) (1, 9)\n    ")
        self.check_tokenize('foo.async', "    NAME       'foo'         (1, 0) (1, 3)\n    OP         '.'           (1, 3) (1, 4)\n    NAME       'async'       (1, 4) (1, 9)\n    ")
        self.check_tokenize('async for a in b: pass', "    NAME       'async'       (1, 0) (1, 5)\n    NAME       'for'         (1, 6) (1, 9)\n    NAME       'a'           (1, 10) (1, 11)\n    NAME       'in'          (1, 12) (1, 14)\n    NAME       'b'           (1, 15) (1, 16)\n    OP         ':'           (1, 16) (1, 17)\n    NAME       'pass'        (1, 18) (1, 22)\n    ")
        self.check_tokenize('async with a as b: pass', "    NAME       'async'       (1, 0) (1, 5)\n    NAME       'with'        (1, 6) (1, 10)\n    NAME       'a'           (1, 11) (1, 12)\n    NAME       'as'          (1, 13) (1, 15)\n    NAME       'b'           (1, 16) (1, 17)\n    OP         ':'           (1, 17) (1, 18)\n    NAME       'pass'        (1, 19) (1, 23)\n    ")
        self.check_tokenize('async.foo', "    NAME       'async'       (1, 0) (1, 5)\n    OP         '.'           (1, 5) (1, 6)\n    NAME       'foo'         (1, 6) (1, 9)\n    ")
        self.check_tokenize('async', "    NAME       'async'       (1, 0) (1, 5)\n    ")
        self.check_tokenize('async\n#comment\nawait', "    NAME       'async'       (1, 0) (1, 5)\n    NEWLINE    '\\n'          (1, 5) (1, 6)\n    COMMENT    '#comment'    (2, 0) (2, 8)\n    NL         '\\n'          (2, 8) (2, 9)\n    NAME       'await'       (3, 0) (3, 5)\n    ")
        self.check_tokenize('async\n...\nawait', "    NAME       'async'       (1, 0) (1, 5)\n    NEWLINE    '\\n'          (1, 5) (1, 6)\n    OP         '...'         (2, 0) (2, 3)\n    NEWLINE    '\\n'          (2, 3) (2, 4)\n    NAME       'await'       (3, 0) (3, 5)\n    ")
        self.check_tokenize('async\nawait', "    NAME       'async'       (1, 0) (1, 5)\n    NEWLINE    '\\n'          (1, 5) (1, 6)\n    NAME       'await'       (2, 0) (2, 5)\n    ")
        self.check_tokenize('foo.async + 1', "    NAME       'foo'         (1, 0) (1, 3)\n    OP         '.'           (1, 3) (1, 4)\n    NAME       'async'       (1, 4) (1, 9)\n    OP         '+'           (1, 10) (1, 11)\n    NUMBER     '1'           (1, 12) (1, 13)\n    ")
        self.check_tokenize('async def foo(): pass', "    NAME       'async'       (1, 0) (1, 5)\n    NAME       'def'         (1, 6) (1, 9)\n    NAME       'foo'         (1, 10) (1, 13)\n    OP         '('           (1, 13) (1, 14)\n    OP         ')'           (1, 14) (1, 15)\n    OP         ':'           (1, 15) (1, 16)\n    NAME       'pass'        (1, 17) (1, 21)\n    ")
        self.check_tokenize('async def foo():\n  def foo(await):\n    await = 1\n  if 1:\n    await\nasync += 1\n', "    NAME       'async'       (1, 0) (1, 5)\n    NAME       'def'         (1, 6) (1, 9)\n    NAME       'foo'         (1, 10) (1, 13)\n    OP         '('           (1, 13) (1, 14)\n    OP         ')'           (1, 14) (1, 15)\n    OP         ':'           (1, 15) (1, 16)\n    NEWLINE    '\\n'          (1, 16) (1, 17)\n    INDENT     '  '          (2, 0) (2, 2)\n    NAME       'def'         (2, 2) (2, 5)\n    NAME       'foo'         (2, 6) (2, 9)\n    OP         '('           (2, 9) (2, 10)\n    NAME       'await'       (2, 10) (2, 15)\n    OP         ')'           (2, 15) (2, 16)\n    OP         ':'           (2, 16) (2, 17)\n    NEWLINE    '\\n'          (2, 17) (2, 18)\n    INDENT     '    '        (3, 0) (3, 4)\n    NAME       'await'       (3, 4) (3, 9)\n    OP         '='           (3, 10) (3, 11)\n    NUMBER     '1'           (3, 12) (3, 13)\n    NEWLINE    '\\n'          (3, 13) (3, 14)\n    DEDENT     ''            (4, 2) (4, 2)\n    NAME       'if'          (4, 2) (4, 4)\n    NUMBER     '1'           (4, 5) (4, 6)\n    OP         ':'           (4, 6) (4, 7)\n    NEWLINE    '\\n'          (4, 7) (4, 8)\n    INDENT     '    '        (5, 0) (5, 4)\n    NAME       'await'       (5, 4) (5, 9)\n    NEWLINE    '\\n'          (5, 9) (5, 10)\n    DEDENT     ''            (6, 0) (6, 0)\n    DEDENT     ''            (6, 0) (6, 0)\n    NAME       'async'       (6, 0) (6, 5)\n    OP         '+='          (6, 6) (6, 8)\n    NUMBER     '1'           (6, 9) (6, 10)\n    NEWLINE    '\\n'          (6, 10) (6, 11)\n    ")
        self.check_tokenize('async def foo():\n  async for i in 1: pass', "    NAME       'async'       (1, 0) (1, 5)\n    NAME       'def'         (1, 6) (1, 9)\n    NAME       'foo'         (1, 10) (1, 13)\n    OP         '('           (1, 13) (1, 14)\n    OP         ')'           (1, 14) (1, 15)\n    OP         ':'           (1, 15) (1, 16)\n    NEWLINE    '\\n'          (1, 16) (1, 17)\n    INDENT     '  '          (2, 0) (2, 2)\n    NAME       'async'       (2, 2) (2, 7)\n    NAME       'for'         (2, 8) (2, 11)\n    NAME       'i'           (2, 12) (2, 13)\n    NAME       'in'          (2, 14) (2, 16)\n    NUMBER     '1'           (2, 17) (2, 18)\n    OP         ':'           (2, 18) (2, 19)\n    NAME       'pass'        (2, 20) (2, 24)\n    DEDENT     ''            (3, 0) (3, 0)\n    ")
        self.check_tokenize('async def foo(async): await', "    NAME       'async'       (1, 0) (1, 5)\n    NAME       'def'         (1, 6) (1, 9)\n    NAME       'foo'         (1, 10) (1, 13)\n    OP         '('           (1, 13) (1, 14)\n    NAME       'async'       (1, 14) (1, 19)\n    OP         ')'           (1, 19) (1, 20)\n    OP         ':'           (1, 20) (1, 21)\n    NAME       'await'       (1, 22) (1, 27)\n    ")
        self.check_tokenize('def f():\n\n  def baz(): pass\n  async def bar(): pass\n\n  await = 2', "    NAME       'def'         (1, 0) (1, 3)\n    NAME       'f'           (1, 4) (1, 5)\n    OP         '('           (1, 5) (1, 6)\n    OP         ')'           (1, 6) (1, 7)\n    OP         ':'           (1, 7) (1, 8)\n    NEWLINE    '\\n'          (1, 8) (1, 9)\n    NL         '\\n'          (2, 0) (2, 1)\n    INDENT     '  '          (3, 0) (3, 2)\n    NAME       'def'         (3, 2) (3, 5)\n    NAME       'baz'         (3, 6) (3, 9)\n    OP         '('           (3, 9) (3, 10)\n    OP         ')'           (3, 10) (3, 11)\n    OP         ':'           (3, 11) (3, 12)\n    NAME       'pass'        (3, 13) (3, 17)\n    NEWLINE    '\\n'          (3, 17) (3, 18)\n    NAME       'async'       (4, 2) (4, 7)\n    NAME       'def'         (4, 8) (4, 11)\n    NAME       'bar'         (4, 12) (4, 15)\n    OP         '('           (4, 15) (4, 16)\n    OP         ')'           (4, 16) (4, 17)\n    OP         ':'           (4, 17) (4, 18)\n    NAME       'pass'        (4, 19) (4, 23)\n    NEWLINE    '\\n'          (4, 23) (4, 24)\n    NL         '\\n'          (5, 0) (5, 1)\n    NAME       'await'       (6, 2) (6, 7)\n    OP         '='           (6, 8) (6, 9)\n    NUMBER     '2'           (6, 10) (6, 11)\n    DEDENT     ''            (7, 0) (7, 0)\n    ")
        self.check_tokenize('async def f():\n\n  def baz(): pass\n  async def bar(): pass\n\n  await = 2', "    NAME       'async'       (1, 0) (1, 5)\n    NAME       'def'         (1, 6) (1, 9)\n    NAME       'f'           (1, 10) (1, 11)\n    OP         '('           (1, 11) (1, 12)\n    OP         ')'           (1, 12) (1, 13)\n    OP         ':'           (1, 13) (1, 14)\n    NEWLINE    '\\n'          (1, 14) (1, 15)\n    NL         '\\n'          (2, 0) (2, 1)\n    INDENT     '  '          (3, 0) (3, 2)\n    NAME       'def'         (3, 2) (3, 5)\n    NAME       'baz'         (3, 6) (3, 9)\n    OP         '('           (3, 9) (3, 10)\n    OP         ')'           (3, 10) (3, 11)\n    OP         ':'           (3, 11) (3, 12)\n    NAME       'pass'        (3, 13) (3, 17)\n    NEWLINE    '\\n'          (3, 17) (3, 18)\n    NAME       'async'       (4, 2) (4, 7)\n    NAME       'def'         (4, 8) (4, 11)\n    NAME       'bar'         (4, 12) (4, 15)\n    OP         '('           (4, 15) (4, 16)\n    OP         ')'           (4, 16) (4, 17)\n    OP         ':'           (4, 17) (4, 18)\n    NAME       'pass'        (4, 19) (4, 23)\n    NEWLINE    '\\n'          (4, 23) (4, 24)\n    NL         '\\n'          (5, 0) (5, 1)\n    NAME       'await'       (6, 2) (6, 7)\n    OP         '='           (6, 8) (6, 9)\n    NUMBER     '2'           (6, 10) (6, 11)\n    DEDENT     ''            (7, 0) (7, 0)\n    ")
...
class TestTokenize(TestCase):
    ...
    def assertExactTypeEqual(self, opstr, *optypes):
        ...
        self.assertEqual(tok_name[tokens[(1 + num_optypes)].exact_type], tok_name[token.NEWLINE])
        self.assertEqual(tok_name[tokens[(2 + num_optypes)].exact_type], tok_name[token.ENDMARKER])
