...
parse_qsl_test_cases = [('', []), ('&', []), ('&&', []), ('=', [('', '')]), ('=a', [('', 'a')]), ('a', [('a', '')]), ('a=', [('a', '')]), ('&a=b', [('a', 'b')]), ('a=a+b&b=b+c', [('a', 'a b'), ('b', 'b c')]), ('a=1&a=2', [('a', '1'), ('a', '2')]), (b'', []), (b'&', []), (b'&&', []), (b'=', [(b'', b'')]), (b'=a', [(b'', b'a')]), (b'a', [(b'a', b'')]), (b'a=', [(b'a', b'')]), (b'&a=b', [(b'a', b'b')]), (b'a=a+b&b=b+c', [(b'a', b'a b'), (b'b', b'b c')]), (b'a=1&a=2', [(b'a', b'1'), (b'a', b'2')]), (';', []), (';;', []), (';a=b', [('a', 'b')]), ('a=a+b;b=b+c', [('a', 'a b'), ('b', 'b c')]), ('a=1;a=2', [('a', '1'), ('a', '2')]), (b';', []), (b';;', []), (b';a=b', [(b'a', b'b')]), (b'a=a+b;b=b+c', [(b'a', b'a b'), (b'b', b'b c')]), (b'a=1;a=2', [(b'a', b'1'), (b'a', b'2')])]
parse_qs_test_cases = [('', {}), ('&', {}), ('&&', {}), ('=', {'': ['']}), ('=a', {'': ['a']}), ('a', {'a': ['']}), ('a=', {'a': ['']}), ('&a=b', {'a': ['b']}), ('a=a+b&b=b+c', {'a': ['a b'], 'b': ['b c']}), ('a=1&a=2', {'a': ['1', '2']}), (b'', {}), (b'&', {}), (b'&&', {}), (b'=', {b'': [b'']}), (b'=a', {b'': [b'a']}), (b'a', {b'a': [b'']}), (b'a=', {b'a': [b'']}), (b'&a=b', {b'a': [b'b']}), (b'a=a+b&b=b+c', {b'a': [b'a b'], b'b': [b'b c']}), (b'a=1&a=2', {b'a': [b'1', b'2']}), (';', {}), (';;', {}), (';a=b', {'a': ['b']}), ('a=a+b;b=b+c', {'a': ['a b'], 'b': ['b c']}), ('a=1;a=2', {'a': ['1', '2']}), (b';', {}), (b';;', {}), (b';a=b', {b'a': [b'b']}), (b'a=a+b;b=b+c', {b'a': [b'a b'], b'b': [b'b c']}), (b'a=1;a=2', {b'a': [b'1', b'2']})]
...
class UrlParseTestCase(unittest.TestCase):
    ...
    def checkRoundtrips(self, url, parsed, split):
        ...
        t = (result.scheme, result.netloc, result.path, result.params, result.query, result.fragment)
    ...
    def test_RFC2368(self):
        self.assertEqual(urllib.parse.urlparse('mailto:1337@example.org'), ('mailto', '', '1337@example.org', '', '', ''))
...
class DeprecationTest(unittest.TestCase):
    ...
    def test_splittype_deprecation(self):
        ...
        self.assertEqual(str(cm.warning), 'urllib.parse.splittype() is deprecated as of 3.8, use urllib.parse.urlparse() instead')

    def test_splithost_deprecation(self):
        with self.assertWarns(DeprecationWarning) as cm:
            urllib.parse.splithost('')
        self.assertEqual(str(cm.warning), 'urllib.parse.splithost() is deprecated as of 3.8, use urllib.parse.urlparse() instead')
    ...
    def test_splitpasswd_deprecation(self):
        ...
        self.assertEqual(str(cm.warning), 'urllib.parse.splitpasswd() is deprecated as of 3.8, use urllib.parse.urlparse() instead')

    def test_splitport_deprecation(self):
        with self.assertWarns(DeprecationWarning) as cm:
            urllib.parse.splitport('')
        self.assertEqual(str(cm.warning), 'urllib.parse.splitport() is deprecated as of 3.8, use urllib.parse.urlparse() instead')

    def test_splitnport_deprecation(self):
        with self.assertWarns(DeprecationWarning) as cm:
            urllib.parse.splitnport('')
        self.assertEqual(str(cm.warning), 'urllib.parse.splitnport() is deprecated as of 3.8, use urllib.parse.urlparse() instead')
    ...
    def test_splitattr_deprecation(self):
        ...
        self.assertEqual(str(cm.warning), 'urllib.parse.splitattr() is deprecated as of 3.8, use urllib.parse.urlparse() instead')

    def test_splitvalue_deprecation(self):
        with self.assertWarns(DeprecationWarning) as cm:
            urllib.parse.splitvalue('')
        self.assertEqual(str(cm.warning), 'urllib.parse.splitvalue() is deprecated as of 3.8, use urllib.parse.parse_qsl() instead')

    def test_to_bytes_deprecation(self):
        with self.assertWarns(DeprecationWarning) as cm:
            urllib.parse.to_bytes('')
        self.assertEqual(str(cm.warning), 'urllib.parse.to_bytes() is deprecated as of 3.8')
