...
import numbers
import locale
from test.support import run_unittest, run_doctest, is_resource_enabled, requires_IEEE_754, requires_docstrings, requires_legacy_unicode_capi
...
class CFunctionality(unittest.TestCase):
    ...
    def test_decimal_api_triple(self):
        ...
        signs = ['', '-']
        coefficients = ['000000000000000000000000000000000000000', '299999999999999999999999999999999999999', '299999999999999999990000000000000000000', '200000000000000000009999999999999999999', '000000000000000000009999999999999999999', '299999999999999999999999999999000000000', '299999999999999999999000000000999999999', '299999999999000000000999999999999999999', '299000000000999999999999999999999999999', '000999999999999999999999999999999999999', '300000000000000000000000000000000000000', '310000000000000000001000000000000000000', '310000000000000000000000000000000000000', '300000000000000000001000000000000000000', '340100000000100000000100000000100000000', '340100000000100000000100000000000000000', '340100000000100000000000000000100000000', '340100000000000000000100000000100000000', '340000000000100000000100000000100000000', '340282366920938463463374607431768211455']
        exponents = ['E+0', 'E+1', 'E-1', ('E+%s' % str((C.MAX_EMAX - 38))), ('E-%s' % str((C.MIN_ETINY + 38)))]
        for sign in signs:
...
class CWhitebox(unittest.TestCase):
    ...
    def test_c_signal_dict(self):
        ...
        IntSignals = {Clamped: C.DecClamped, Rounded: C.DecRounded, Inexact: C.DecInexact, Subnormal: C.DecSubnormal, Underflow: C.DecUnderflow, Overflow: C.DecOverflow, DivisionByZero: C.DecDivisionByZero, FloatOperation: C.DecFloatOperation, InvalidOperation: C.DecIEEEInvalidOperation}
        ...
        for r in range(lim):
            for t in range(lim):
                for round in RoundingModes:
                    ...
                    c = Context(prec=prec, rounding=round, Emin=emin, Emax=emax, capitals=caps, clamp=clamp, flags=list(flags), traps=list(traps))
    ...
    @unittest.skipIf(sys.platform.startswith('aix'), 'AIX: default ulimit: test is flaky because of extreme over-allocation')
