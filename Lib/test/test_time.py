...
class TimeTestCase(unittest.TestCase):
    ...
    @unittest.skipUnless(hasattr(time, 'pthread_getcpuclockid'), 'need time.pthread_getcpuclockid()')
    @unittest.skipUnless(hasattr(time, 'clock_gettime'), 'need time.clock_gettime()')
    ...
    def _bounds_checking(self, func):
        ...
        self.assertEqual(func((1900, 1, 1, 0, 0, 0, (- 1), 1, (- 1))), func((1900, 1, 1, 0, 0, 0, (+ 6), 1, (- 1))))
