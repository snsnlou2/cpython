...
<body><tag>ø</tag></body>''', 'unicode', True)]
    ...
    def test_tostringlist_xml_declaration(self):
        ...
        self.assertEqual(''.join(stringlist), f'''<?xml version='1.0' encoding='{preferredencoding}'?>
<body><tag /></body>''')
