...
WaitPidMocks = collections.namedtuple('WaitPidMocks', ('waitpid', 'WIFEXITED', 'WIFSIGNALED', 'WEXITSTATUS', 'WTERMSIG'))
...
class ChildWatcherTestsMixin():
    ...
    def waitpid_mocks(func):
        ...
        def wrapped_func(self):
            ...
            with patch('os.WTERMSIG', self.WTERMSIG) as m_WTERMSIG, patch('os.WEXITSTATUS', self.WEXITSTATUS) as m_WEXITSTATUS, patch('os.WIFSIGNALED', self.WIFSIGNALED) as m_WIFSIGNALED, patch('os.WIFEXITED', self.WIFEXITED) as m_WIFEXITED, patch('os.waitpid', self.waitpid) as m_waitpid:
                func(self, WaitPidMocks(m_waitpid, m_WIFEXITED, m_WIFSIGNALED, m_WEXITSTATUS, m_WTERMSIG))
        return wrapped_func
