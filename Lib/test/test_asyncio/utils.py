...
class TestLoop(base_events.BaseEventLoop):
    ...
    def assert_reader(self, fd, callback, *args):
        ...
        if (handle._callback != callback):
            raise AssertionError(f'unexpected callback: {handle._callback} != {callback}')
