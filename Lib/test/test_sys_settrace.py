...
def arigo_example0():
    ...
    while 0:
        pass
    x = 1
arigo_example0.events = [(0, 'call'), (1, 'line'), (2, 'line'), (5, 'line'), (5, 'return')]
...
def arigo_example1():
    ...
    if 0:
        pass
    x = 1
arigo_example1.events = [(0, 'call'), (1, 'line'), (2, 'line'), (5, 'line'), (5, 'return')]
...
def arigo_example2():
    ...
    if 1:
        ...
        pass
    return None
arigo_example2.events = [(0, 'call'), (1, 'line'), (2, 'line'), (4, 'line'), (7, 'line'), (7, 'return')]
...
def tightloop_example():
    ...
    try:
        ...
        pass
tightloop_example.events = [(0, 'call'), (1, 'line'), (2, 'line'), (3, 'line'), (5, 'line'), (5, 'line'), (5, 'line'), (5, 'line'), (5, 'exception'), (6, 'line'), (7, 'line'), (7, 'return')]
...
class JumpTracer():
    ...
    def trace(self, frame, event, arg):
        ...
        if ((event == self.event) and self.firstLine and (frame.f_lineno == (self.firstLine + self.jumpFrom))):
            f = frame
