...
class FinderTests(abc.FinderTests):
    ...
    def get_finder(self, root):
        loader_details = [(self.machinery.SourceFileLoader, self.machinery.SOURCE_SUFFIXES), (self.machinery.SourcelessFileLoader, self.machinery.BYTECODE_SUFFIXES)]
    ...
    def test_package(self):
        ...
        self.run_test('pkg', {'pkg.__init__'}, compile_={'pkg.__init__'}, unlink={'pkg.__init__'})
    ...
    def test_empty_string_for_dir(self):
        finder = self.machinery.FileFinder('', (self.machinery.SourceFileLoader, self.machinery.SOURCE_SUFFIXES))
    ...
    @unittest.skipUnless((sys.platform != 'win32'), 'os.chmod() does not support the needed arguments under Windows')
...
(Frozen_FinderTestsPEP451, Source_FinderTestsPEP451) = util.test_both(FinderTestsPEP451, machinery=machinery)
...
(Frozen_FinderTestsPEP420, Source_FinderTestsPEP420) = util.test_both(FinderTestsPEP420, machinery=machinery)
...
(Frozen_FinderTestsPEP302, Source_FinderTestsPEP302) = util.test_both(FinderTestsPEP302, machinery=machinery)
