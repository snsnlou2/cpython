...
class SymbolTests(unittest.TestCase):
    VALID_ARGS = (ID('x/y/z/spam.c', 'func', 'eggs'), Symbol.KIND.VARIABLE, False)
    ...
    def test_init_typical_binary_local(self):
        ...
        symbol = Symbol(id=id, kind=Symbol.KIND.VARIABLE, external=False)
        self.assertEqual(symbol, (id, Symbol.KIND.VARIABLE, False))
    ...
    def test_init_all_missing(self):
        id = ID(None, None, 'spam')
        symbol = Symbol(id)
        self.assertEqual(symbol, (id, Symbol.KIND.VARIABLE, None))
