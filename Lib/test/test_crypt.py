...
class CryptTestCase(unittest.TestCase):
    ...
    @unittest.skipUnless((crypt and ((crypt.METHOD_SHA256 in crypt.methods) or (crypt.METHOD_SHA512 in crypt.methods))), 'requires support of SHA-2')
    ...
    @unittest.skipUnless((crypt and (crypt.METHOD_BLOWFISH in crypt.methods)), 'requires support of Blowfish')
