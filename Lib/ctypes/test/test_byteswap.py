...
class Test(unittest.TestCase):
    ...
    def test_struct_fields_1(self):
        ...
        class T(base):
            pass
        _fields_ = [('a', c_ubyte), ('b', c_byte), ('c', c_short), ('d', c_ushort), ('e', c_int), ('f', c_uint), ('g', c_long), ('h', c_ulong), ('i', c_longlong), ('k', c_ulonglong), ('l', c_float), ('m', c_double), ('n', c_char), ('b1', c_byte, 3), ('b2', c_byte, 3), ('b3', c_byte, 2), ('a', (((c_int * 3) * 3) * 3))]
        T._fields_ = _fields_
