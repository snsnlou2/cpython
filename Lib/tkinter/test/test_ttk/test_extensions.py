...
class LabeledScaleTest(AbstractTkTest, unittest.TestCase):
    ...
    def test_initialization_no_master(self):
        with swap_attr(tkinter, '_default_root', None), swap_attr(tkinter, '_support_default_root', True):
            try:
                x = ttk.LabeledScale()
    ...
    def test_initialization(self):
        ...
        x.destroy()
        passed_expected = (('0', 0), (0, 0), (10, 10), ((- 1), (- 1)), ((sys.maxsize + 1), (sys.maxsize + 1)), (2.5, 2), ('2.5', 2))
