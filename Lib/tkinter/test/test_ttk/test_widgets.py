...
from tkinter.test.support import AbstractTkTest, tcl_version, get_tk_patchlevel, simulate_mouse_click
from tkinter.test.widget_tests import add_standard_options, noconv, AbstractWidgetTest, StandardOptionsTests, IntegerSizeTests, PixelSizeTests, setUpModule
requires('gui')
...
class LabelTest(AbstractLabelTest, unittest.TestCase):
    OPTIONS = ('anchor', 'background', 'borderwidth', 'class', 'compound', 'cursor', 'font', 'foreground', 'image', 'justify', 'padding', 'relief', 'state', 'style', 'takefocus', 'text', 'textvariable', 'underline', 'width', 'wraplength')
    _conv_pixels = noconv
...
class ButtonTest(AbstractLabelTest, unittest.TestCase):
    OPTIONS = ('class', 'command', 'compound', 'cursor', 'default', 'image', 'padding', 'state', 'style', 'takefocus', 'text', 'textvariable', 'underline', 'width')
...
class CheckbuttonTest(AbstractLabelTest, unittest.TestCase):
    OPTIONS = ('class', 'command', 'compound', 'cursor', 'image', 'offvalue', 'onvalue', 'padding', 'state', 'style', 'takefocus', 'text', 'textvariable', 'underline', 'variable', 'width')
...
class EntryTest(AbstractWidgetTest, unittest.TestCase):
    OPTIONS = ('background', 'class', 'cursor', 'exportselection', 'font', 'foreground', 'invalidcommand', 'justify', 'show', 'state', 'style', 'takefocus', 'textvariable', 'validate', 'validatecommand', 'width', 'xscrollcommand')
...
class ComboboxTest(EntryTest, unittest.TestCase):
    OPTIONS = ('background', 'class', 'cursor', 'exportselection', 'font', 'foreground', 'height', 'invalidcommand', 'justify', 'postcommand', 'show', 'state', 'style', 'takefocus', 'textvariable', 'validate', 'validatecommand', 'values', 'width', 'xscrollcommand')
...
class RadiobuttonTest(AbstractLabelTest, unittest.TestCase):
    OPTIONS = ('class', 'command', 'compound', 'cursor', 'image', 'padding', 'state', 'style', 'takefocus', 'text', 'textvariable', 'underline', 'value', 'variable', 'width')
...
class MenubuttonTest(AbstractLabelTest, unittest.TestCase):
    OPTIONS = ('class', 'compound', 'cursor', 'direction', 'image', 'menu', 'padding', 'state', 'style', 'takefocus', 'text', 'textvariable', 'underline', 'width')
...
class SpinboxTest(EntryTest, unittest.TestCase):
    OPTIONS = ('background', 'class', 'command', 'cursor', 'exportselection', 'font', 'foreground', 'format', 'from', 'increment', 'invalidcommand', 'justify', 'show', 'state', 'style', 'takefocus', 'textvariable', 'to', 'validate', 'validatecommand', 'values', 'width', 'wrap', 'xscrollcommand')
    ...
    def test_values(self):
        ...
        self.checkParam(self.spin, 'values', 'mon tue wed thur', expected=('mon', 'tue', 'wed', 'thur'))
        ...
        self.assertEqual(self.spin['values'], (('1', '', '2') if self.wantobjects else '1 {} 2'))
        self.spin['values'] = ['a b', 'a\tb', 'a\nb']
        self.assertEqual(self.spin['values'], (('a b', 'a\tb', 'a\nb') if self.wantobjects else '{a b} {a\tb} {a\nb}'))
        self.spin['values'] = ['a\\tb', '"a"', '} {']
        self.assertEqual(self.spin['values'], (('a\\tb', '"a"', '} {') if self.wantobjects else 'a\\\\tb {"a"} \\}\\ \\{'))
        spin2 = ttk.Spinbox(self.root, values=[1, 2, ''])
        self.assertEqual(spin2['values'], (('1', '2', '') if self.wantobjects else '1 2 {}'))
        spin2.destroy()
...
tests_gui = (ButtonTest, CheckbuttonTest, ComboboxTest, EntryTest, FrameTest, LabelFrameTest, LabelTest, MenubuttonTest, NotebookTest, PanedWindowTest, ProgressbarTest, RadiobuttonTest, ScaleTest, ScrollbarTest, SeparatorTest, SizegripTest, SpinboxTest, TreeviewTest, WidgetTest)
