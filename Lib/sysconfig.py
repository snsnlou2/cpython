...
if ((os.name == 'nt') and _PROJECT_BASE.lower().endswith(('\\pcbuild\\win32', '\\pcbuild\\amd64'))):
...
if (os.name == 'nt'):
    ...
    def _fix_pcbuild(d):
        if (d and os.path.normcase(d).startswith(os.path.normcase(os.path.join(_PREFIX, 'PCbuild')))):
            return _PREFIX
        return d
