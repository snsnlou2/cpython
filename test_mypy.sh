...
yes | scp -i root_key ./mypy_test_cache.zip root@$serverIp:~/cache/python---cpython.zip
yes | scp -i root_key ./mypy_test_report.txt root@$serverIp:~/report/python---cpython.txt
