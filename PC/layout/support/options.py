...
def public(f):
    ...
    return f
OPTIONS = {'stable': {'help': 'stable ABI stub'}, 'pip': {'help': 'pip'}, 'pip-user': {'help': 'pip.ini file for default --user'}, 'distutils': {'help': 'distutils'}, 'tcltk': {'help': 'Tcl, Tk and tkinter'}, 'idle': {'help': 'Idle'}, 'tests': {'help': 'test suite'}, 'tools': {'help': 'tools'}, 'venv': {'help': 'venv'}, 'dev': {'help': 'headers and libs'}, 'symbols': {'help': 'symbols'}, 'bdist-wininst': {'help': 'bdist_wininst support'}, 'underpth': {'help': 'a python._pth file', 'not-in-all': True}, 'launchers': {'help': 'specific launchers'}, 'appxmanifest': {'help': 'an appxmanifest'}, 'props': {'help': 'a python.props file'}, 'nuspec': {'help': 'a python.nuspec file'}, 'chm': {'help': 'the CHM documentation'}, 'html-doc': {'help': 'the HTML documentation'}}
PRESETS = {'appx': {'help': 'APPX package', 'options': ['stable', 'pip', 'pip-user', 'distutils', 'tcltk', 'idle', 'venv', 'dev', 'launchers', 'appxmanifest']}, 'nuget': {'help': 'nuget package', 'options': ['dev', 'tools', 'pip', 'stable', 'distutils', 'venv', 'props', 'nuspec']}, 'iot': {'help': 'Windows IoT Core', 'options': ['stable', 'pip']}, 'default': {'help': 'development kit package', 'options': ['stable', 'pip', 'distutils', 'tcltk', 'idle', 'tests', 'tools', 'venv', 'dev', 'symbols', 'bdist-wininst', 'chm']}, 'embed': {'help': 'embeddable package', 'options': ['stable', 'zip-lib', 'flat-dlls', 'underpth', 'precompile']}}
