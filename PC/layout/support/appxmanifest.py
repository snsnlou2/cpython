...
IDLE_VE_DATA = dict(DisplayName='IDLE (Python {})'.format(VER_DOT), Description='IDLE editor for Python {}'.format(VER_DOT), Square150x150Logo='_resources/pythonwx150.png', Square44x44Logo='_resources/pythonwx44.png', BackgroundColor='transparent')
...
def get_appxmanifest(ns):
    ...
    if (winver < (10, 0, 17763)):
        winver = (10, 0, 17763)
    find_or_add(xml, 'm:Dependencies/m:TargetDeviceFamily').set('MaxVersionTested', '{}.{}.{}.0'.format(*winver))
    if (winver > (10, 0, 17763)):
